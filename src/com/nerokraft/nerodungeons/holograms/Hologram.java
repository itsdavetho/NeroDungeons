...
public class Hologram {
	...
	public Hologram(String text, Location location, Holograms instance) throws NoSuchMethodException, SecurityException,
	...
	public void setSmall(boolean small) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		NmsUtil.getArmorStand().getMethod("setSmall", boolean.class).invoke(this.armorStand, small);
	}
	
	public void setMarker(boolean marker) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
	...
	public void updateLocation(Location location) throws NoSuchMethodException, SecurityException,
			IllegalAccessException, IllegalArgumentException, InvocationTargetException, InstantiationException, NoSuchFieldException {
